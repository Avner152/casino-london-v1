...
export default function AboutUs() {
  return (
    <>
      <Helmet>
        <title>
          About buzzcasinosuk.com: Reviews, Responsible Gambling & Contact
          Information
        </title>
        <meta
          name="description"
          content="Learn more about buzzcasinosuk.com. Discover our mission to provide honest, comprehensive reviews of the best UK online casinos. For inquiries or suggestions. Play responsibly!"
        />
      </Helmet>
      <div className="_w-100 text-bg-dark text-white pt-5 pb-5 mt-3 information">
        <div className="m-auto pt-3">
          <h2>About Us – buzzcasinosuk.com</h2>
          <span>18+</span>
          <div className="mt-3">
            <p>
              At <strong>buzzcasinosuk.com</strong>, we deliver comprehensive,
