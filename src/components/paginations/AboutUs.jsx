...
export default function AboutUs() {
  return (
    <>
      <Helmet>
        <title>
          About CasinoCompareUK.net: Reviews, Responsible Gambling & Contact
          Information
        </title>
        <meta
          name="description"
          content="Learn more about casinocompareuk.net. Discover our mission to provide honest, comprehensive reviews of the best UK online casinos. For inquiries or suggestions. Play responsibly!"
        />
      </Helmet>
      <div className="_w-100 text-bg-dark text-white pt-5 pb-5 mt-3 information">
        <div className="m-auto pt-3">
          <h2>About Us - CasinoCompareUK.net</h2>
          <span>18+</span>
          <div className="mt-3">
            <p>
              At <strong>CasinoCompareUK.net</strong>, we deliver comprehensive,
