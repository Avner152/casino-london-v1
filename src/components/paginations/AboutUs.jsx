...
export default function AboutUs() {
  return (
    <>
      <Helmet>
        <title>
          About CasinoBuzzUK.com: Reviews, Responsible Gambling & Contact
          Information
        </title>
        <meta
          name="description"
          content="Learn more about casinobuzzuk.com. Discover our mission to provide honest, comprehensive reviews of the best UK online casinos. For inquiries or suggestions. Play responsibly!"
        />
      </Helmet>
      <div className="_w-100 text-bg-dark text-white pt-5 pb-5 mt-3 information">
        <div className="m-auto pt-3">
          <h2>About Us - CasinoBuzzUK.com</h2>
          <span>18+</span>
          <div className="mt-3">
            <p>
              At <strong>CasinoBuzzUK.com</strong>, we deliver comprehensive,
