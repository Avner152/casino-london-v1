...
export default function Terms() {
  ...
  const meta = {
    title: "Terms and Conditions | topcasinosuk.net",
    description:
      "Read the Terms and Conditions for using topcasinosuk.net's website and services. Learn about your rights, obligations, and the rules governing your use of our site.",
  };
  return (
    <>
      <Helmet>
      ...
      <div className="_w-100 text-bg-dark text-white pt-5 pb-5 mt-3 information">
        <div className="m-auto pt-3">
          ...
          <p>
            ...
            By accessing or using topcasinosuk.net, you agree to be bound by
