...
export default function LiveRoulette() {
  ...
  const topPar = {
    ...
    list: [
      ...
      `Place your bets and feel the thrill - experience the best of live roulette in ${curDate.getFullYear()} with casinoportaluk.net!`,
    ],
  };
  ...
  const tips = {
    ...
    p: "With tech innovations like multiple camera angles and slow - motion replays, live roulette continues to evolve. Get ready for a world - class experience - play live roulette on casinoportaluk.net and enjoy the spin of a lifetime. Always play responsibly.",
  };
