...
export default function PrivacyPolicy() {
  ...
  const meta = {
    title: "Privacy Policy | CasinoBuzzUK.com",
    description:
      "Review the Privacy Policy for casinobuzzuk.com. Learn how we collect, use, and protect your personal information, including data usage and third - party services",
  };
  return (
    <>
      <Helmet>
      ...
      <div className="_w-100 text-bg-dark text-white pt-5 pb-5 mt-3 information">
        <div className="m-auto pt-3">
          ...
          <div>
            <h4>Terms of Use</h4>
            <p>
              This Privacy Policy is an integral part of CasinoBuzzUK.com's
          ...
          <div>
            ...
            <p>
              Information You Provide to Us Certain services on CasinoBuzzUK.com
          ...
          <div>
            ...
            <p>
              CasinoBuzzUK.com may feature blogs, reviews, and promotional
