...
export default function CookiePolicy() {
  ...
  const meta = {
    ...
    description:
      "Read our Cookie Policy for casinoportaluk.net. Learn about the types of cookies we use, how they help improve your experience, and how to manage your cookie preferences on our site.",
  };
  return (
    <>
      <Helmet>
