...
export default function CookiePolicy() {
  ...
  const meta = {
    title: "Cookie Policy | BuzzCasinosUK.com",
    description:
      "Read our Cookie Policy for buzzcasinosuk.com. Learn about the types of cookies we use, how they help improve your experience, and how to manage your cookie preferences on our site.",
  };
  return (
    <>
      <Helmet>
